    ...
    public class DeviceModel : INotifyPropertyChanged
    {
        ...
        public string StatusDisplay
        {
            get
            {
                ...
                if (delta.TotalMinutes < 60) return $"Last seen {Math.Floor(delta.TotalMinutes)} min ago";
                if (delta.TotalHours < 24) return $"Last seen {Math.Floor(delta.TotalHours)} h ago";
                return $"Last seen {Math.Floor(delta.TotalDays)} d ago";
            }
        }
